...
load('InitialState_CaseStudyI.mat')
...
T_load_b3=2010;                                      %load step at bus 3 at time T_load_b3
...
%% Simulation events 
%Load step at buses 6 and 3
Load_step_b6 = 30e6;
Load_step_b3 = 0.4*P_set_bus3;
